...
<title>Mpowerjobz - Dream Bigger</title>
...
<div class="container">
        ...
        <ul class="employersList">
		 ...
		 ?>
          <li><a href="<?php echo base_url('company/'.$row_top_employer->company_slug);?>" title="Jobs in <?php echo $row_top_employer->company_name;?>"><img src="<?php echo base_url('public/uploads/employer/thumb/'.$company_image_name);?>" alt="<?php echo base_url('company/'.$row_top_employer->company_slug);?>" /></a>
             
              <!--a><?php echo $total_opened_jobs;?></a-->
              <hr/>
               <a href="<?php echo base_url('company/'.$row_top_employer->company_slug);?>"><?php echo $row_top_employer->company_name;?></a>
          </li>
    ...
    <div style="text-align:center; margin-top: 30px;">
        <a href="<?php echo base_url()?>index.php/companies" class="view-all">View all Companies</a>
    </div>
      </div>
</div>
<!--Employers Ends-->
...
<div class="container-fluid">
 <?php $this->load->view('common/blog');?>   
</div>
</div>
<div>&nbsp;</div>
<!-- Blog post -->
