<div class="footerWrap">
  <div class="container">
    <div class="col-md-3">
      ...
      <br><br>
      <p>This recruitment firm partners with thousands of leading firms, both national and international. MPowerJobz gives an open option to all these firms to pick up the most apt eligible aspirant for the job they have to offer. The aspirant scan join hands with MPowerJobz to find the job of their choice. For this, they just need to upload their resume on MPowerJobz.</p>
    ...
    <div class="clear"></div>
    <div class="copyright">
    <a href="<?php echo base_url('interview.html');?>" title="Preparing for Interview">Products</a> |
    <a href="<?php echo base_url('interview.html');?>" title="Preparing for Interview">FAQ's</a> |
    ...
    <a href="<?php echo base_url('privacy-policy.html');?>" title="Policy">Terms & Policies</a>
